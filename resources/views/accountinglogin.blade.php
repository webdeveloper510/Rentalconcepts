            ...
            <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3">
                <div class="panel border bg-white">
                    <div class="panel-heading">
                        ...
                        <h3 class="pt-3 font-bold">Accounting Login</h3>
                    </div>
                    <div class="panel-body p-3">
                        ...
                        @endif
                        <form action="{{ url('accounting') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-inline"> <a href="{{ url('/forgetpassword') }}" id="forgot" class="font-weight-bold">Forgot password?</a> </div>
