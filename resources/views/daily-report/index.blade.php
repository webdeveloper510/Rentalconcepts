        ...
        <div class="row mts-5">
            <div class="main" style="width: 100%; display: flex;">
                <div class="container1" style="width: 30%; margin-top: 138px;">
                    <form method="POST" action="{{url('/admin/upload-daily-report')}}" enctype="multipart/form-data" class="fileup-form" style="height: 403px;
                            margin-left: 388px;
                            border-radius: 10px;
                        ...
                        <div class="alert alert-danger alert-dismissible text-white" style="
                            margin-left: 160px;
                            margin-top: 28px;
                            position: absolute;
                            font-size: smaller; 
